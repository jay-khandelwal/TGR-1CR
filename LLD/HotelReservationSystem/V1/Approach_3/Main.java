package LLD.HotelReservationSystem.V1.Approach_3;
...
interface RoomRepository {
    void addRoom(Staff staff, String roomNumber, RoomType roomType);
    List<Room> getAllRooms();
    List<Room> findAvailableRooms(RoomType roomType, LocalDate fromDate, LocalDate toDate, List<Booking> bookings)
            throws InvalidBookingException;
}

interface GuestRepository {
    Guest registerGuest(Staff staff, String name, String email, String phoneNumber);
    List<Guest> getAllGuests();
}

interface BookingRepository {
    Booking createBooking(Staff staff, Guest guest, RoomType roomType, LocalDate fromDate, LocalDate toDate)
            throws RoomNotAvailableException, InvalidBookingException, DateOverlapException;
    void cancelBooking(Staff staff, String bookingId) throws BookingNotFoundException;
    List<Booking> getAllBookings();
}

interface PaymentRepository {
    Payment makePayment(Staff staff, int amount, PaymentMode paymentMode, String transactionId, PaymentStatus status)
            throws PaymentFailedException;
    List<Payment> getAllPayments();
}

interface InvoiceRepository {
    Invoice generateInvoice(Staff staff, Booking booking, Payment payment);
    List<Invoice> getAllInvoices();
}

interface StaffRepository {
    Staff registerStaff(String name);
    List<Staff> getAllStaff();
}

// RoomService implementing RoomRepository
...
// GuestService implementing GuestRepository
...
// BookingService implementing BookingRepository
class BookingService implements BookingRepository {
    ...
    public Booking createBooking(Staff staff, Guest guest, RoomType roomType, LocalDate fromDate, LocalDate toDate)
        ...
        List<Room> availableRooms = roomRepository.findAvailableRooms(roomType, fromDate, toDate, bookings);
...
// PaymentService implementing PaymentRepository
...
// InvoiceService implementing InvoiceRepository
...
// StaffService implementing StaffRepository
...
class HotelManagementFacade {
    ...
    public HotelManagementFacade() {
        this.roomRepository = new RoomService();
        this.guestRepository = new GuestService();
        this.bookingRepository = new BookingService(roomRepository);
        this.paymentRepository = new PaymentService();
        this.invoiceRepository = new InvoiceService();
        this.staffRepository = new StaffService();
    }

    public Staff registerStaff(String name) {
        return staffRepository.registerStaff(name);
    }

    public void addRoom(Staff staff, String roomNumber, RoomType roomType) {
        roomRepository.addRoom(staff, roomNumber, roomType);
    }
    ...
    public Guest registerGuest(Staff staff, String name, String email, String phoneNumber) {
        return guestRepository.registerGuest(staff, name, email, phoneNumber);
    }
    ...
    public Booking createBooking(Staff staff, Guest guest, RoomType roomType, LocalDate fromDate, LocalDate toDate)
            throws RoomNotAvailableException, InvalidBookingException, DateOverlapException {
        return bookingRepository.createBooking(staff, guest, roomType, fromDate, toDate);
    }

    public void cancelBooking(Staff staff, String bookingId) throws BookingNotFoundException {
        bookingRepository.cancelBooking(staff, bookingId);
    }
    ...
    public Payment makePayment(Staff staff, int amount, PaymentMode paymentMode, String transactionId, PaymentStatus status)
            throws PaymentFailedException {
        return paymentRepository.makePayment(staff, amount, paymentMode, transactionId, status);
    }

    public Invoice generateInvoice(Staff staff, Booking booking, Payment payment) {
        return invoiceRepository.generateInvoice(staff, booking, payment);
    }
